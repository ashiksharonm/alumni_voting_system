...
const LoginPage = () => {
  ...
  const positions = [
    ...new Set(initialNominees.map((nominee) => nominee.position)),
  ];
  const nomineesByPosition = {};
  positions.forEach((position) => {
    nomineesByPosition[position] = initialNominees.filter(
  ...
  return (
    <div className="container" style={{ backgroundColor: "#efe6d1" }}>
      <div className="login-header-container">
        <img
          src={lc}
          style={{ height: "120px", width: "120px", margin: "15px" }}
          alt="LICET Logo"
          className="logo"
        />
        <h1
          className="election-title"
          style={{ fontSize: "35px", color: "#1e1445", marginTop: "40px" }}
        >
      ...
      <div className="login-card" style={{ backgroundColor: "#FFF" }}>
        <form>
          <label htmlFor="regno" style={{ color: "#1e1445" }}>
            Registration Number
          </label>
          <input
            required
          ...
          />
          <br />
          <label htmlFor="dob" style={{ color: "#1e1445" }}>
            Date of Birth
          </label>
          <input
            required
